    ...
    public class LoginViewModel : ViewModelBase
    {
        ...
        private async Task Login()
        {
            try
            {
                ...
                {
                    NavigateToManagerViewCommand = new NavigateToManagerViewCommand(user, _navigationStore);
                    NavigateToManagerViewCommand.Execute(this);
                }
                else if(user.Role=="Employee")
                {
                    NavigateToEmployeeViewCommand = new NavigateToEmployeeViewCommand(user, _navigationStore);
